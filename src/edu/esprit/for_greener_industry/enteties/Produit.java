...
public class Produit {
    ...
    public IntegerProperty getId_entrepriseProperty() {
        IntegerProperty idp = new SimpleIntegerProperty(id_entreprise);
        return idp;
    }
    ...
    public FloatProperty getPrixProperty() {
        FloatProperty prixp = new SimpleFloatProperty(prix);
        return prixp;
    }
    ...
    public IntegerProperty getStock_actuelleProperty() {
        IntegerProperty pstock = new SimpleIntegerProperty(stock_actuelle);
        return pstock;
    }
    ...
    public IntegerProperty getProduction_mentuelleProperty() {
        IntegerProperty pstock = new SimpleIntegerProperty(production_mentuelle);
        return pstock;
    }
    ...
    public float getPollution_par_piéce() {
     ...
     public FloatProperty getPollution_par_piéceProperty() {
        FloatProperty prixp = new SimpleFloatProperty(pollution_par_piéce);
        return prixp;
    }
    ...
    public String getLibellet() {
     ...
     public StringProperty getLibelletProperty() {
        StringProperty prixp = new SimpleStringProperty(libellet);
        return prixp;
    }
    ...
    public StringProperty getDescriptionProperty() {
        StringProperty prixp = new SimpleStringProperty(description);
        return prixp;
    }
    ...
    public String getImg() {
     ...
     public StringProperty getImgProperty() {
        StringProperty prixp = new SimpleStringProperty(img);
        return prixp;
    }
